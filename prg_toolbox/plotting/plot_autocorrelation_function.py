...
def set_autocorrelation_function_values_and_kwargs(
    DEFAULT_LINE_KWARGS,
    DEFAULT_FILL_KWARGS,
    plot_kwargs,
    fill_kwargs,
    ...
    if data_type_name == "autocorrelation_function":
        ...
        raise ValueError(
            "Data must be either a autocorrelation_function object or a dictionary."
        )
...
def plot_autocorrelation_function(
    ...
    values, plot_kw, fill_kw = set_autocorrelation_function_values_and_kwargs(
        DEFAULT_LINE_KWARGS,
        DEFAULT_FILL_KWARGS,
        plot_kwargs,
        fill_kwargs,
    ...
    if surrogate_data is not None and type(surrogate_data) == type(data):
        values_surrogate, plot_kw, fill_kw = (
            set_autocorrelation_function_values_and_kwargs(
                DEFAULT_LINE_KWARGS,
                DEFAULT_FILL_KWARGS,
                plot_kwargs,
                fill_kwargs,
