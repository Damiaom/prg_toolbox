...
def labels_avalanche_covariance_eigenvalue(data, surrogate_data = None):
    """
    ...
    label_dict = {
        "xlabel": r"$C_{size}$",
        "ylabel": "Avalanche Covariance Eigenvalue",
        "legend": legend
    }
    return label_dict

def draw_plot_avalanche_covariance_eigenvalue(values, ax, plot_kw=None, fill_kw=None):
    """
...
def plot_avalanche_covariance_eigenvalue(
    data,
    surrogate_data = None,
    ax=None,
    style_config=None,
    ...
    draw_plot_avalanche_covariance_eigenvalue(values, ax, plot_kw, fill_kw)
    ...
    if surrogate_data is not None and type(surrogate_data) == type(data):
        ...
        draw_plot_avalanche_covariance_eigenvalue(values_surrogate, ax, plot_kw, fill_kw)
