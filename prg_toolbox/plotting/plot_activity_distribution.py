...
def labels_activity_distribution(data, surrogate_data=None):
    ...
    legend = (
        [result_legend, surrogate_legend, "Gaussian"]
        if surrogate_legend
        else [result_legend, "Gaussian"]
    )
    label_dict = {
...
def set_activity_distribution_values_and_kwargs(
    DEFAULT_LINE_KWARGS,
    DEFAULT_FILL_KWARGS,
    plot_kwargs,
    fill_kwargs,
    ...
    if data_type_name == "activity_distribution":
        ...
        raise ValueError(
            "Data must be either a realspace_activity_distribution object or a dictionary."
        )
...
def plot_activity_distribution(
    ...
    values, plot_kw, fill_kw = set_activity_distribution_values_and_kwargs(
        DEFAULT_LINE_KWARGS,
        DEFAULT_FILL_KWARGS,
        plot_kwargs,
        fill_kwargs,
    ...
    if surrogate_data is not None and type(surrogate_data) == type(data):
        values_surrogate, plot_kw, fill_kw = (
            set_activity_distribution_values_and_kwargs(
                DEFAULT_LINE_KWARGS,
                DEFAULT_FILL_KWARGS,
                plot_kwargs,
                fill_kwargs,
