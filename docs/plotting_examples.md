...
The examples below use 3 independent random 64-unit subsamples of simulated data of the model from Schmidt et al. (2018), alongside the same pipeline run
...
The examples below push a few kwargs hard on purpose -- star markers, exaggerated sizes, a hatch
