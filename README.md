...
PRG Toolbox is a Python package that implements the Phenomenological Renormalization Group (PRG) coarse graining method introduced by Meshulam et al. (2019) [1,2]. It performs model-free multiscale analysis designed to study scale-invariant behavior and collective dynamics in high-dimensional multivariate time series, such as multi-neuron spike recordings or fMRI data [3,4].
...
```bash
pip install git+https://github.com/Damiaom/prg_toolbox.git
```
